<template>
  <header
    class="br_header header-default one-page-header light-logo-version headroom--sticky clearfix"
      ...
      <div class="header-left-wrapper">
        ...
        <div class="header-left-inner">
          <div class="header-page-menu-style-2 d-none d-xl-block">
            <div
              class="manu-hamber-2 hamberger-trigger"
              @click="$emit('toggleFullpageMenu')"
            >
              <div>
                <i></i>
              </div>
          ...
          <div class="header-page-menu-style-2 d-block d-xl-none">
            <div
              class="manu-hamber-2 popup-mobile-click"
