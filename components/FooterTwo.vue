          ...
          <div class="col-lg-4 col-sm-6">
            <div class="footer-widget text-var--2">
              ...
              <div class="footer-inner">
                <p>
                  Brook is a multi-purpose WordPress theme for big and
                  small-sized businesses. Enjoy the theme's original design,
                  functional features & responsive layouts.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="footer-widget text-var--2 menu--instagram">
              ...
              <div class="ft-instagram-list">
                <div class="instagram-grid-wrap">
                  <div
                    class="item-grid grid-style--1"
                    v-for="instagram in instagramPosts"
                    :key="instagram.id"
                  >
                    <div class="thumb">
                      <nuxt-link to="">
                        <img
                          :src="useAssetUrl(instagram.image)"
                          alt="instagram image"
                        />
                      </nuxt-link>
                      <div class="item-info">
